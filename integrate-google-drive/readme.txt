...
**🛠️ Shortcode Builder**
The Shortcode Builder lets you easily create customizable modules like File Browsers and Galleries. Use the shortcode to add these modules anywhere on your website. 🎬 [Watch Video](https://youtu.be/8M84lcvfCiI)
...
= 1.4.0 (2024-08-26) =
* New: Added woocommerce upload box checkout location setting.
* Fix: Fixed MetForm Google Drive upload filed not saving the configuration data.
* Fix: Fixed remove file button not working for Google Drive uploader forms field.
* Fix: Fixed WPForms Google Drive upload filed smart tag output issue.

= 1.3.99 (2024-08-14) =
* **Fix:** Fixed Invalid nonce error.
* **Fix:** Fixed permission check issue.
* **Fix:** Fixed conflict with the Real Media Library plugin.
...
* **New:** Added dynamic option to use ACF field value as module source files.
* **New:** Added usage limits options to control download and bandwidth usage.
* **Fix:** Fixed direct media embed not working.
* **Fix:** Fixed search results not showing proper pagination issue.
* **Fix:** Fixed Google account not switching in the media library integration.
* **Fix:** Fixed Elementor form multiple Google Drive upload field configuration issue.
* **Update:** Revert the Gallery Shortcode Module and Contact Form 7 Integration to the free version.
* **Update:** Added support up to WordPress 6.6.1.
* **Update:** Improved the overall performance and stability of the plugin.

= 1.3.96 (2024-06-11) =
* Fix: Fixed PHP fatal error.

= 1.3.95 (2024-06-10) =
* **New:** Added thumbnail preview for selected items for the uploader module.
* **New:** Added server throttle setting to prevent resource issues during downloading/streaming on budget hosts.
* **New:** Added secure video playback setting to prevent direct access to Google Drive video files.
* **Fix:** Fixed Shared drives folder navigation not working properly.
* **Fix:** Fixed Formidable Forms file and folder naming template issue.
* **Fix:** Fixed NinjaForms file not uploading issue.
* **Fix:** Fixed Google Drive files selection from media library in mobile view.
* **Update:** Improved video playback speed.
...
= 1.3.93 (2024-04-04) =
* **Fix:** Fixed file browser not working in mobile.

= 1.3.92 (2024-04-01) =
* **New:** Added description field for the uploader module files.
* **Fix:** Fixed media player not playing properly.
* **Fix:** Fixed large file download scan warning issue.
* **Fix:** Fixed statistics data not exporting properly.
* **Fix:** Fixed Google Drive media attachment not displaying in gallery.
* **Update:** Improved media library integration.
* **Update:** Improved overall performance and security.
