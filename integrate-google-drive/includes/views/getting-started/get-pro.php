...
<div id="get-pro" class="getting-started-content content-get-pro">
    <div class="content-heading">
        <h2><?php printf(__( '%sMaximize Google Drive%s with WordPress', 'integrate-google-drive' ), '<mark>', '</mark>'); ?></h2>
        <p><?php esc_html_e( 'Unlock powerful PRO features designed to enhance and streamline your Google Drive integration, making it more efficient and easier to manage than ever before.', 'integrate-google-drive' ) ?>
            .</p>

        <a href="<?php echo igd_fs()->get_upgrade_url(); ?>" class="igd-btn btn-primary get-pro-btn">
    ...
    <div class="content-heading free-vs-pro">
        <h2><?php esc_html_e( 'Compare Features', 'integrate-google-drive' ); ?></h2>
    ...
    <div class="get-pro-cta">
        <div class="cta-content">
            <h2><?php printf(__( 'Don\'t waste time, get the %s PRO version %s now!', 'integrate-google-drive' ), '<mark>', '</mark>'); ?></h2>
        ...
        <div class="cta-btn">
            <a href="<?php echo igd_fs()->get_upgrade_url(); ?>"
